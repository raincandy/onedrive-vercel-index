...
module.exports = {
  ...
  userPrincipalName: process.env.NEXT_PUBLIC_USER_PRINCIPLE_NAME || 'i@aoikaze.onmicrosoft.com',      // process.env.NEXT_PUBLIC_USER_PRINCIPLE_NAME || 'spencer@spwoo.onmicrosoft.com',
  ...
  title: process.env.NEXT_PUBLIC_SITE_TITLE || "NNM的OneDrive",
