...
module.exports = {
  ...
  userPrincipalName: 'i@aoikaze.onmicrosoft.com', // process.env.NEXT_PUBLIC_USER_PRINCIPLE_NAME || 'spencer@spwoo.onmicrosoft.com',
  ...
  baseDirectory: '/其他用途的分享', // process.env.NEXT_PUBLIC_BASE_DIRECTORY || '/',
